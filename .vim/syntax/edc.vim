...
syn keyword	edcBlock 	color_classes color_class rel1 rel2 rel contained
...
syn keyword	edcLabel	mouse_events repeat_events clip_to no_render contained
...
syn keyword	edcConstant	COMP RAW LOSSY LOSSY_ETC1 LOSSY_ETC2 NONE ON_HOLD AUTOGRAB NOGRAB
syn keyword	edcConstant	TEXT IMAGE RECT TEXTBLOCK SWALLOW GRADIENT GROUP EXTERNAL
...
syn keyword	edcConstant	FOCUS_OBJECT
...
syn keyword	edcConstant	VERTICAL HORIZONTAL BOTH BOX TABLE SOURCE
